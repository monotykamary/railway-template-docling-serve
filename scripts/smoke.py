...
payload={'options':{'from_formats':['md'],'to_formats':['md','text'],'do_ocr':False,'do_table_structure':False},'file_sources':[{'base64_string':base64.b64encode(b'# Railway Docling Validation\n\nConversion works.').decode(),'filename':'railway-validation.md'}]}
