...
Deploy the official CPU-only Docling Serve 1.30.0 image as an API-key-protected document conversion service.
...
- Release: https://github.com/docling-project/docling-serve/releases/tag/v1.30.0
- License: MIT
